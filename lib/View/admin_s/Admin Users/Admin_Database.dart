...
class Admin_Database extends StatefulWidget {
  const Admin_Database({super.key});

  @override
  State<Admin_Database> createState() => _Admin_DatabaseState();
}

class _Admin_DatabaseState extends State<Admin_Database> {
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Text("Admin Database",style: TextStyle(fontSize: responsiveTextSize(20),fontWeight: FontWeight.bold),)
  ...
  void AdminPrint(Map<String, dynamic> user) async {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Center(child:pw.Text('Admins Infromation Record', style: pw.TextStyle(fontSize: 25,fontWeight:pw.FontWeight.bold)),),
              pw.SizedBox(height: 50),
              pw.Text('User ID : ${user['id'] ?? 'N/A'}', style: pw.TextStyle(fontSize: 20)),
              pw.SizedBox(height: 18),
              pw.Text('Name : ${user['name'] ?? 'N/A'}', style: pw.TextStyle(fontSize: 20)),
              pw.SizedBox(height: 18),
              pw.Text('Contact Number : ${user['Number'] ?? 'N/A'}', style: pw.TextStyle(fontSize: 20)),
              pw.SizedBox(height: 18,),
              pw.Text('Designation : ${user['designation'] ?? 'N/A'}', style: pw.TextStyle(fontSize: 20)),
